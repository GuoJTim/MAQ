...
from double_RLPDMAQ import MAQDBDRLPDSACAgent
import argparse
import os
import torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--double_k', type=int, default=64)
    ...
    if args.type == 'DSAC':
        ...
        base_config["logdir"] = f'log/exp_{suffix}/{env}/DBRLPDMAQ/'
        agent_class = MAQDBDRLPDSACAgent
